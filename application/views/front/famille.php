...
<h2 style="color: #3FC1EA;"><i class="fa fa-users fa-lg" aria-hidden="true" style="color: #3FC1EA;margin-left: -50px"></i>Familles</h2>
        </div>
...
<!--etape 1-->
        ...
        <a><p style=";"><?php echo $data->papier1;?></a>
            ...
            <ul>
                ...
                <li><p style=";text-align: center;color: #3FC1EA "><?php echo $data->Etape;?></p></li>
            </ul>
              </div>
        </div>
<!--etape 2-->
<div class="mainDiv">
        ...
        <a><p style=";"><?php echo $data->papier2;?></a>
            ...
            <ul>
                ...
                <li><p style=";text-align: center;color: #3FC1EA "><?php echo $data->Class;?></p></li>
            </ul>
              </div>
        </div>
...
<div class="mainDiv">
        ...
        <a><p style=";"><?php echo $data->papier3;?></a>
            ...
            <ul>
                ...
                <li><p style=";text-align: center;color: #3FC1EA "><?php echo $data->DEMARCHE;?></p></li>
            </ul>
              </div>
        </div>
</div>
